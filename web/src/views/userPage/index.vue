<template>
  <div class="user-page">
    <div class="filter">
      <el-button size="mini" type="primary" @click="createUser">添加用户</el-button>
    </div>
    ...
    <el-dialog
      ...
      <el-form label-width="80px" ref="userForm" :model="userForm" :rules="rules">
        <el-form-item label="用户名:" prop="username">
          <el-input class="the-input" size="mini" v-model="userForm.username"></el-input>
        </el-form-item>
        <el-form-item label="密码:" prop="password">
          <el-input class="the-input" size="mini" v-model="userForm.password" type="password"></el-input>
        </el-form-item>
...
import { getUsers, createUser, editUser, deleteUser } from '@/apis/user.api'
export default {
  name: 'DataPage',
  data () {
    return {
